...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        father_passing_prob = (
            (1 - PROBS["mutation"]) if genes_father == 2
                               else 0.5 if genes_father == 1 
                               else PROBS["mutation"])
        
        mother_passing_prob = (
            (1 - PROBS["mutation"]) if genes_mother == 2
                               else 0.5 if genes_mother == 1 
                               else PROBS["mutation"])
        
        if genes == 2:
            prob_gene = father_passing_prob * mother_passing_prob
        elif genes == 1:
            prob_gene = (father_passing_prob * (1 - mother_passing_prob) + mother_passing_prob * (1 - father_passing_prob))
        else:
            prob_gene = (1 - father_passing_prob) * (1 - mother_passing_prob)
        ...
        total_probability *= prob_gene * prob_trait
